...
dataset.properties <- list(
                          ...
                          Muraro_pancreas=list(sample_threshold=30,gene_name_type="SYMBOL",
                                                              cell_types=c('beta','alpha','delta',
                                                                          'acinar','ductal','gamma',
                                                                          'endothelial')),
                          Segerstolpe_pancreas=list(sample_threshold=30,gene_name_type="SYMBOL",
                                               cell_types=c('beta','alpha','delta',
                                                            'acinar','ductal','gamma',
                                                            'endothelial')),
                          Xin_pancreas=list(sample_threshold=30,gene_name_type="SYMBOL",
                                               cell_types=c('beta','alpha','delta',
                                                            'acinar','ductal','gamma',
                                                            'endothelial')),
