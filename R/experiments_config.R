...
experiments.methods <- list(
  ...
  cell_number=list(cluster=c('seurat','tscan'),assign=c('scmap_cluster','scmap_cell','chetah')),
  sequencing_depth=list(cluster=c('seurat','tscan'),assign=c('scmap_cluster','scmap_cell','chetah')),
