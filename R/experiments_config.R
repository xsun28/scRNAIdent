...
experiments.methods <- list(
  simple_accuracy=list(cluster=c('sc3','suerat','tscan','cidr'),assign=c('scmap','chetah','garnet','cellassign')), 
  cell_number=list(cluster=c('sc3','suerat','tscan','cidr'),assign=c('scmap','chetah','garnet','cellassign')),
