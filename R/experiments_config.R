experiments.cluster.data <- list(simple_accuracy="GSE96583_8_Stim_Pats.RDS", 
                                 ...
                                 inter_diseases = list("GSE96583_8_Ctrl_Pats.RDS","GSE96583_8_Stim_Pats.RDS","GSE96583_batch1_3_samples.RData"),
...
experiments.parameters <- list(
  ...
  batch_effects=list(sample_num=NA,cv=FALSE,remove_batch=TRUE,metrics=c('ARI','AMI','FMI'),
                     marker_gene_file=NULL),
  inter_diseases = list(sample_num=500,cv=FALSE,metrics=c('ARI','AMI','FMI'),marker_gene_file=NULL),
  celltype_complexity = list(),
  inter_species = list(),
  random_noise = list(),
  inter_protocol = list()
