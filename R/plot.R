...
plot.imbalance_impacts <- function(results,raw_results,fig_path,...){
  ...
  plot_params <- list(x="methods",y="value",fill="supervised",label="label",xlabel="methods",
                      facet_wrap=T,dodged=T,facet_var='imbl_entropy',width=10,height=7,nrow=3)
  ...
  ######single method performance vs cell type pctg

  single_method_results <- dplyr::arrange(single_method_results, type,type_pctg)
  single_method_results$label <- round(single_method_results$FMI,2)
  plot_params <- list(x="method",y="FMI",fill="supervised",xlabel="methods", ylabel="FMI",label="label",
                      facet_grid=T,dodged=T,facet_grid_x="type",facet_grid_y="imbl_entropy",width=10,height=7,nrow=length(unique(single_method_results$imbl_entropy)))
  ...
  plot.line_plot(single_method_results,plot_params,fig_path,"type_pctg_FMI.pdf")
  
  #######single assign method unlabeled pctg vs cell type pctg
  single_assign_method_results <- dplyr::filter(single_method_results, supervised)
  plot_params <- list(x="type_pctg",y="unlabeled_pctg",group="methods",line_color="methods",point_color="methods",
                      facet_wrap=T,dodged=T,facet_var="type",width=10,height=7)
  plot.line_plot(single_assign_method_results,plot_params,fig_path,"type_pctg_unlabeled.pdf")
  #######single assign method accuracy vs cell type pctg
  plot_params <- list(x="type_pctg",y="assign_accuracy",group="methods",line_color="methods",point_color="methods",
                      facet_wrap=T,dodged=T,facet_var="type",width=10,height=7)
  plot.line_plot(single_assign_method_results,plot_params,fig_path,"type_pctg_assign_accuracy.pdf")
}
